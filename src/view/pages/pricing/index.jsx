        ...
        <Card className="hp-border-color-black-40 hp-pb-sm-0 hp-pb-64">
          <Row>
            <Col span={24}>
              ...
              <p className="hp-p1-body hp-mb-0">Get unlimited versions with our detailed plans</p>
            </Col>

            <Col span={24}>
              <Row align="middle" justify="center" className="hp-mt-32 hp-mb-24">
                <span className={`hp-caption ${billedValue ? 'hp-text-color-black-60' : 'hp-text-color-primary-1'}`}>
                  Billed monthly
                </span>

                <Switch className="hp-mx-8" defaultChecked onChange={onChange} />

                <span className={`hp-caption ${billedValue ? 'hp-text-color-primary-1' : 'hp-text-color-black-60'}`}>
                  Billed Yearly
                </span>
              </Row>
