        ...
        <Row align="middle" justify="space-between">
          <Col xl={10} lg={14} md={16} span={24}>
            ...
            <p className="h5 hp-font-weight-400 hp-text-color-black-80 hp-text-color-dark-30 hp-mb-48 hp-pr-96">
              Powerfull Template customer service with our tools, hendrerit omittantur mel, es vidit Ius te omittantur
              ...
              <Col span={24}>
                <Row align="middle">
                  <Col>
                    <Avatar
                      size={60}
                      icon={<TickSquare set="bold" style={{ width: 24, height: 24, marginLeft: 0 }} />}
                    />
                  </Col>
