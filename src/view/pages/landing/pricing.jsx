...
export default function LandingPricing() {
  ...
  const itemValues = [
    ...
    },
    {
      ...
      best: true,
      button: 'Try it for free',
      list: ['10gb Space', '1 User', 'Team inbox', 'Website Analitcs', 'Promotional Pop-ups']
    },
    {
      title: 'Advanced',
      subTitle: 'Simple explanation',
      ...
      best: false,
      button: 'Try it for free',
      list: ['Promotional Pop-ups', 'Lorem Ipsum', 'Dolor Sit', 'Website Analitcs', '24/7 Customer Support']
    }
  ];
        ...
        <div>
          <Row justify="space-between">
            <Col lg={item.best ? 15 : 24} md={item.best ? 10 : 24} span={item.best ? 15 : 24}>
              ...
              <p className="hp-caption hp-mb-sm-8 hp-text-color-black-60">{item.subTitle}</p>
            </Col>
          ...
          <p className="hp-caption hp-mt-sm-0 hp-mt-4 hp-mb-0 hp-text-color-black-60">{item.billed}</p>
      ...
      <div className="hp-landing-container">
        <Row>
          <Col span={24} className="hp-text-center">
            ...
            <p className="hp-p1-body hp-mt-sm-0 hp-mt-32 hp-mb-0">Get unlimited versions with our detailed plans</p>
          </Col>
            ...
            <Row align="middle" justify="center" className="hp-mt-64 hp-mb-32">
              <span
                className={`hp-caption ${
                  billedValue ? 'hp-text-color-black-100 hp-text-color-dark-0' : 'hp-text-color-primary-1'
                }`}
              >
                Billed monthly
              </span>
              ...
              <span
                className={`hp-caption ${
                  billedValue ? 'hp-text-color-primary-1' : 'hp-text-color-black-100 hp-text-color-dark-0'
                }`}
              >
                Billed annually
              </span>
