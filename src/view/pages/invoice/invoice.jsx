  ...
  return (
    <Card id="invoice" className="hp-mb-32 hp-invoice-card">
      <Row justify="space-between">
        ...
        <Col>
          <p className="hp-p1-body hp-mb-16">INVOICE NUMBER #125863478945</p>
        </Col>
      ...
      <Row justify="space-bewtween">
        <Col md={8} xs={24} className="hp-pb-16 hp-print-info">
          <p className="hp-text-color-black-100 hp-text-color-dark-0 hp-input-label">CLIENT INFORMATION:</p>
          <p>Edward Yildirim</p>
        ...
        <Col md={8} xs={24} className="hp-pb-16 hp-print-info">
          <p className="hp-text-color-black-100 hp-text-color-dark-0 hp-input-label">ORDER INFORMATION:</p>
          <p>Date: November 14</p>
          <p>Status: Pending</p>
          <p>Id : #146859</p>
        </Col>

        <Col md={8} xs={24} className="hp-text-sm-left hp-text-right hp-print-info">
