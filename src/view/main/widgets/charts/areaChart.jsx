...
export default function AreaChart() {
  ...
  const [data] = useState({
    series: [
      {
        name: 'Visit',
        data: [10877, 29334, 33233, 36439, 32675, 32333, 33457, 38345, 36783, 30457, 28459, 29840]
      },
      {
        name: 'Click',
        data: [8753, 21313, 24623, 28935, 27345, 23465, 27813, 29125, 26256, 24356, 20233, 24570]
      },
      {
        name: 'Sales',
        data: [6000, 11313, 14623, 18935, 17345, 13465, 17813, 19125, 16256, 20356, 16233, 14570]
      }
    ],
    options: {
      chart: {
