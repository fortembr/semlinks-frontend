          ...
          <Row gutter={[16, 16]}>
            <Col span={24} className="hp-mb-8">
              <span className="hp-p1-body hp-text-color-black-80 hp-text-color-dark-30">
                Type = <span className="hp-text-color-black-100 hp-text-color-dark-0">Flat</span>
              </span>
            ...
            <Col lg={12} span={24}>
              <SelectBoxItem id="select-box-item-1" name="select-box-item" title="Pink Xbox Controller" />
            </Col>

            <Col lg={12} span={24}>
              <SelectBoxItem id="select-box-item-2" name="select-box-item" title="Pink Xbox Controller" />
            </Col>
          </Row>
        </Col>
            ...
            <Col lg={12} span={24}>
              <SelectBoxItem
                ...
                description={[
                  ...
                  <a
                    href="mailto:hi-london@hypeople.studio"
                    className="hp-text-color-black-80 hp-text-color-dark-30 hp-hover-text-color-primary-1 hp-hover-text-color-dark-primary-2"
                  >
                    hi-london@hypeople.studio
                  </a>,
                  <a
                    href="tel:+‭447597201543‬"
                    className="hp-text-color-black-80 hp-text-color-dark-30 hp-hover-text-color-primary-1 hp-hover-text-color-dark-primary-2"
                  >
                    ‭+44-7597-201543‬
                  </a>
