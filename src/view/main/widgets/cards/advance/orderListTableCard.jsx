...
export default function OrderlistTableCard() {
  const columns = [
    {
      title: (
        <span className="hp-badge-size hp-font-weight-400 hp-text-color-black-bg hp-text-color-dark-0">Order ID</span>
      ),
      dataIndex: 'id',
      key: 'id',
    ...
    {
      title: (
        <span className="hp-badge-size hp-font-weight-400 hp-text-color-black-bg hp-text-color-dark-0">Product</span>
      ),
      dataIndex: 'product',
      key: 'product',
      render: (text, record) => {
    ...
    {
      title: (
        <span className="hp-badge-size hp-font-weight-400 hp-text-color-black-bg hp-text-color-dark-0">Status</span>
      ),
      key: 'tags',
      dataIndex: 'tags',
      render: (tags) => (
    ...
    {
      title: (
        <span className="hp-badge-size hp-font-weight-400 hp-text-color-black-bg hp-text-color-dark-0">Price</span>
      ),
      dataIndex: 'price',
      key: 'price'
    }
