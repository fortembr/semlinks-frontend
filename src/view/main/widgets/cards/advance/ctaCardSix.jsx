    ...
    <Card className="hp-border-color-black-40 hp-card-6 hp-border-radius-xxl hp-overflow-hidden">
      <Row>
        <Col span={24} style={{ top: -24, right: -24 }} className="hp-text-right">
          <svg height={264} fill="none" xmlns="http://www.w3.org/2000/svg">
            <path
        ...
        <Col span={24} className="hp-mt-64">
          <Row>
            <Col flex="1 0 0">
              <h3 className="hp-mb-0 hp-font-weight-600 hp-text-color-black-bg hp-text-color-dark-0">Knowledge Base</h3>
            </Col>

            <Col>
              <ArrowRight size="24" className="hp-text-color-black-100 hp-text-color-dark-10" />
            </Col>
          </Row>
        </Col>
      </Row>
