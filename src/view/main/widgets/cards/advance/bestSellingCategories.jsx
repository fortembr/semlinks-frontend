  ...
  return (
    <Card className="hp-border-color-black-40 hp-card-4">
      <Row>
        ...
        <Col span={24}>
          <Row className="hp-bestSellingCategories" gutter={[16, 16]} justify="space between">
            {categories.map((category, index) => (
              <Col key={index} span={24}>
                <Row justify="space-between">
                    ...
                    <Row>
                      ...
                      <Col className="hp-align-self-center">
                        <p className="hp-mb-4 hp-text-color-black-100 hp-text-color-dark-0 hp-badge-text hp-font-weight-500">
                          {category.sales >= 1000 ? `${category.sales / 1000}K` : `${category.sales}`}
                          Sales
                        </p>
                  ...
                  <Col className="hp-align-self-center">
                    <p className="hp-mb-4 hp-p1-body">${category.total / 1000}K</p>
                  </Col>
                </Row>
              </Col>
            ))}
