      ...
      <Row>
        ...
        <Col className="hp-mt-8">
          <h3 className="hp-mb-4">
            1,243
            <span className="hp-badge-text hp-ml-8 hp-text-color-secondary-1">+4%</span>
          </h3>

          <p className="hp-p1-body hp-mb-0 hp-text-color-black-80 hp-text-color-dark-30">New Orders</p>
        </Col>
      </Row>
    </Card>
  );
