  ...
  return (
    <Card className="hp-border-color-black-40">
      <Row justify="space-between">
        <Col md={12} span={24}>
          <h5>Best team</h5>
          <p className="hp-p1-body hp-text-color-black-60 hp-text-color-dark-50 hp-mb-0">Highest income this month</p>
        ...
        <Col md={12} span={24} className="hp-mt-sm-32">
          ...
          <Row align="middle" justify="center">
            <Avatar size={36} src={marketingImg1} className="hp-mr-8 hp-bg-color-primary-3" />

            <Avatar size={36} src={marketingImg2} className="hp-mr-8 hp-bg-color-info-3" />

            <Avatar size={36} src={marketingImg3} className="hp-mr-8 hp-bg-color-black-60" />

            <Avatar size={36} src={marketingImg4} className="hp-mr-8 hp-bg-color-danger-3" />

            <Avatar size={36} src={marketingImg5} className="hp-mr-8 hp-bg-color-secondary-3" />

            <Avatar size={36} src={marketingImg6} className="hp-mr-16 hp-bg-color-warning-3" />
