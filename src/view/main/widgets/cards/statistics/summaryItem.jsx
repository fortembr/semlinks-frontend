    ...
    <div className="hp-nft-dashboard-summary-item hp-border-1 hp-border-color-black-40 hp-border-color-dark-80 hp-border-radius-xxl hp-bg-black-0 hp-bg-dark-100 hp-p-16 hp-card-1 hp-overflow-hidden">
      <Row wrap={false}>
        <Col flex="1 0 0">
          ...
          >
            <Chart options={chartData.options} series={chartData.series} type="line" height="100%" legend="legend" />
          </div>
        </Col>
        ...
        <Col flex="0 0 126px">
          <div
            className={`${
              dark ? `hp-bg-black-10` : `hp-bg-${type}-4`
            } hp-border-radius hp-bg-dark-90 hp-text-right hp-p-12 hp-position-relative hp-overflow-hidden hp-d-flex hp-d-flex-justify-center hp-d-flex-column`}
            style={{
              height: 88
            }}
          >
            ...
            <div className="hp-d-flex-center hp-d-flex-end hp-mt-6">
              <svg
                className={dark ? `hp-fill-black-100` : `hp-fill-${type}-1`}
                width="10"
                height="9"
                viewBox="0 0 10 9"
                fill="none"
              ...
              <span className={`${dark ? `hp-text-color-black-100` : `hp-text-color-${type}-1`} hp-p1-body hp-ml-8`}>
                25.7%
              </span>
            </div>
          </div>
