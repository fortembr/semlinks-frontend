...
export default function CreditCard() {
  return (
    <div
      className="hp-overflow-hidden hp-position-relative hp-border-radius-xxl hp-bg-primary-1 hp-pt-24 hp-px-24 hp-pb-18"
      style={{ minHeight: 200 }}
    >
      <div className="hp-position-absolute-bottom-left hp-w-100" style={{ height: '90%' }}>
        <svg width="100%" height="100%" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          />
          <defs>
            <linearGradient id="a" x1={151.96} y1={17.382} x2={195.449} y2={191.807} gradientUnits="userSpaceOnUse">
              <stop stopColor="#fff" />
