...
export default function BalanceCard() {
  ...
  const [data] = useState({
    series: [
      {
        name: 'Balance',
        data: [28877, 29334, 33233, 36439, 32675, 32333, 33457, 38345, 36783, 39457, 22459, 39840]
      }
    ],
    options: {
      chart: {
  ...
  return (
    <Row>
      ...
      <Col span={24} className="hp-overflow-hidden">
        <Chart options={data.options} series={data.series} type="bar" width="100%" height={250} legend="legend" />
      </Col>
    </Row>
  );
}
