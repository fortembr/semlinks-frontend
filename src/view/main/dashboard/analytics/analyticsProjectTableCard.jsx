...
export default function AnalyticsProjectTableCard() {
  const columns = [
    {
      title: (
        <span className="hp-badge-size hp-font-weight-400 hp-text-color-black-60 hp-text-color-dark-40 hp-text-uppercase">
          #
        </span>
      ),
      dataIndex: 'no',
    ...
    },
    {
      ...
      key: 'projectName',
      render: (text) => <p className="hp-mb-0 hp-text-color-black-80 hp-text-color-dark-30">{text}</p>
    },
    {
      title: (
        <span className="hp-badge-size hp-font-weight-400 hp-text-color-black-60 hp-text-color-dark-40 hp-text-uppercase">
