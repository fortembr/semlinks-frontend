  ...
  return (
    <Card className="hp-border-color-black-40 hp-card-6 hp-pb-24">
      <Row>
        ...
        <Col span={24}>
          <div id="revenue-radar-card" className="hp-d-flex-full-center hp-donut-chart">
            <Chart options={data.options} series={data.series} type="radar" height="85%" legend="legend" />
          </div>
        </Col>
      </Row>
    </Card>
