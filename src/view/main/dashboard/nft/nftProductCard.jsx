        ...
        <Col md={13} span={24} className="hp-mt-sm-24">
          <Row className="hp-h-100 hp-d-flex-column" justify="space-between">
            <Col>
              ...
              <span className="hp-d-block h3 hp-text-color-black-100 hp-text-color-dark-0 hp-mb-24">
                Contemporary Colour Abstract Painting
              </span>
            </Col>
            ...
            <Col>
              ...
              >
                ...
                <Row justify="space-between">
                  <Col>
                    <span className="hp-p1-body hp-font-weight-500 hp-text-color-black-80 hp-text-color-dark-30">
                      Current <br /> Bid
                    </span>
                  </Col>
              ...
              >
                ...
                <Row justify="space-between">
                  ...
                  <Col>
                    <Row>
                      <Col>
                        <span className="h4 hp-text-color-primary-1 hp-text-color-dark-primary-2 hp-font-weight-500 hp-mb-8">
                          00
                        </span>
                        <span className="hp-d-block hp-badge-text hp-font-weight-500 hp-text-color-black-60">
                          Hours
                        </span>
                      </Col>

                      <Col>
                        <span className="hp-d-block h4 hp-text-color-black-100 hp-text-color-dark-20 hp-mx-6">:</span>
                      </Col>
              ...
              <Row gutter={[16, 16]} className="hp-mt-16">
                <Col span={12}>
                  <Button type="primary" block className="hp-border-radius-full">
                    Place Bid
                  </Button>
                </Col>

                <Col span={12}>
                  <Button type="primary" block ghost className="hp-border-radius-full">
                    View Art
                  </Button>
                </Col>
              </Row>
