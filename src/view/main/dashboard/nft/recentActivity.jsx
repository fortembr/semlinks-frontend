...
export default function RecentActivityNFT() {
  ...
  return (
    <>
      ...
      <Row
        align="middle"
        className="hp-mb-18 hp-bg-black-0 hp-bg-dark-100 hp-border-1 hp-border-color-black-40 hp-border-color-dark-80 hp-border-radius-xxl hp-p-8"
      >
        <Col>
          <div
            ...
            style={{
              minWidth: 64,
              height: 64,
              backgroundImage: 'url(' + activityBg1 + ')',
        ...
        <Col flex="1 0 0" className="hp-overflow-hidden">
          ...
          <p
            ...
            title="Transfered from 0xb5687123 🔥"
          >
            Transfered from 0xb5687123 🔥
          </p>
          <span className="hp-d-block hp-caption hp-font-weight-500 hp-text-color-black-60 hp-text-color-dark-40">
            23 min ago
          </span>
        </Col>
      </Row>
        ...
        <Col>
          <div
            ...
            style={{
              minWidth: 64,
              height: 64,
              backgroundImage: 'url(' + activityBg2 + ')',
              backgroundSize: 'cover',
              backgroundPosition: 'center'
            }}
          ></div>
        ...
        <Col>
          <div
            ...
            style={{
              minWidth: 64,
              height: 64,
              backgroundImage: 'url(' + activityBg3 + ')',
              backgroundSize: 'cover',
              backgroundPosition: 'center'
            }}
          ></div>
      ...
      <Row
        align="middle"
        className="hp-bg-black-0 hp-bg-dark-100 hp-border-1 hp-border-color-black-40 hp-border-color-dark-80 hp-border-radius-xxl hp-p-8"
      >
        <Col>
          <div
            className="hp-mr-18 hp-border-radius-xxl"
            style={{
              minWidth: 64,
              height: 64,
              backgroundImage: 'url(' + activityBg4 + ')',
              backgroundSize: 'cover',
              backgroundPosition: 'center'
            }}
          ></div>
