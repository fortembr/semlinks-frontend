    ...
    <Card className="hp-border--xxl hp-overflow-hidden hp-card-3 hp-border-1 hp-border-color-black-40 hp-border-color-dark-80">
      ...
      <Row align="bottom" justify="space-between" className="hp-mt-8">
        <Col>
          <Row>
            <Col className="hp-pr-64 hp-pr-sm-16">
              <span className="hp-d-block hp-w-100 hp-caption hp-text-color-black-80 hp-text-color-dark-20">
                Current bid
              </span>

              <div className="hp-d-flex-center hp-mb-4">
                <span className="h5 hp-text-color-primary-1 hp-text-color-dark-primary-2 hp-font-weight-500 hp-mr-6">
                  0.00050 ETH
                </span>
            ...
            <Col>
              <span className="hp-d-block hp-w-100 hp-caption hp-text-color-black-80 hp-text-color-dark-20 hp-mb-4">
                Auction Ending In
              </span>
        ...
        <Col className="hp-mt-sm-24">
          <Row gutter={[16, 16]}>
            <Col>
              <Button type="primary" ghost className="hp-border-radius-full">
                View Artwork
              </Button>
            </Col>
