  ...
  return (
    <div className="hp-border-radius-xxl hp-bg-black-0 hp-bg-dark-100 hp-border-1 hp-border-color-black-40 hp-border-color-dark-80 hp-p-16">
      <div className="hp-position-relative hp-border-radius-xxl hp-mb-24 hp-nft-dashboard-slider-item">
        <div
          className="hp-position-absolute-top-left hp-w-100 hp-h-100 hp-border-radius-xxl"
          style={{
        ...
        <Col>
          ...
          {item.lastBid && (
            <span className="hp-d-block hp-p1-body hp-text-color-black-80 hp-text-color-dark-20">
              Last Bid: {item.lastBid}
            </span>
          )}
        </Col>

        <Col>
          <span className="hp-d-block hp-ml-12" style={{ color: '#98AFB7' }}>
            {item.price}
          </span>
        </Col>
      </Row>
