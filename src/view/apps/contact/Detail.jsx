...
import { RiArrowLeftSLine, RiUserLine, RiErrorWarningLine } from 'react-icons/ri';
              ...
              <Row>
                <Col span={24}>
                  <Link to="/apps/contact">
                    <Button type="text" shape="square" icon={<RiArrowLeftSLine size={24} />}></Button>
                  </Link>
                </Col>
        ...
        <Content className="hp-bg-color-black-0 hp-bg-color-dark-100 hp-p-24">
          {selectedUser.informationText && (
            <>
              <Col md={15} span={24}>
                ...
                <p className="hp-p1-body hp-mb-0">{selectedUser.informationText}</p>
              </Col>
          ...
          {selectedUser.aboutText && (
            <>
              <Col md={15} span={24}>
                <h3>About</h3>
                <p className="hp-p1-body hp-mb-0">{selectedUser.aboutText}</p>
              </Col>
