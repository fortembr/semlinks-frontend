  ...
  return (
    <Col lg={6} span={24}>
      <div className="hp-p-24 hp-border-radius hp-border-1 hp-border-color-black-40 hp-border-color-dark-80 hp-bg-color-black-0 hp-bg-color-dark-100">
        ...
        <p className="hp-mt-16 hp-mb-0 hp-p1-body">Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
        ...
        {content && (
          <>
            ...
            <a
              ...
              className="hp-transition hp-hover-text-color-primary-1 hp-hover-text-color-dark-primary-2 hp-d-block hp-mb-12 hp-badge-text hp-font-weight-400 hp-text-color-black-60 hp-text-color-dark-40"
            >
              edward@example.com
            </a>

            <a
              href="tel:07877856649"
              className="hp-transition hp-hover-text-color-primary-1 hp-hover-text-color-dark-primary-2 hp-d-block hp-badge-text hp-font-weight-400 hp-text-color-black-60 hp-text-color-dark-40"
            >
              078 7785 6649
            </a>
        ...
        <Row className="hp-mt-8">
          <Col span={24} className="hp-mt-8">
            <Row align="middle" justify="space-between">
              <Col span={12} className="hp-input-description hp-text-color-black-80 hp-text-color-dark-30">
                Suptotal
              </Col>
          ...
          <Col span={24} className="hp-mt-8">
            <Row align="middle" justify="space-between">
              ...
              <Col span={12} className="hp-text-right hp-p1-body hp-font-weight-500 hp-text-color-primary-1">
                {summaryOtherPrice.delivery === 0 ? <>Free</> : <>${summaryOtherPrice.delivery}</>}
              </Col>
            </Row>
          </Col>
          ...
          <Col span={24} className="hp-mt-8">
            <Row align="middle" justify="space-between">
              ...
              <Col span={12} className="hp-text-right hp-p1-body hp-font-weight-500 hp-text-color-primary-1">
                {summaryOtherPrice.tax === 0 ? <>Free</> : <>${summaryOtherPrice.tax}</>}
              </Col>
            </Row>
          </Col>
          ...
          <Col span={24} className="hp-mt-8">
            <Row align="middle" justify="space-between">
              ...
              <Col span={12} className="hp-text-right hp-p1-body hp-font-weight-500 hp-text-color-primary-1">
                {summaryOtherPrice.insurance === 0 ? <>Free</> : <>${summaryOtherPrice.insurance}</>}
              </Col>
            </Row>
          </Col>
        </Row>
        ...
        <Row className="hp-mt-16">
          <Col span={24}>
            <Row align="middle" justify="space-between">
              <Col span={12} className="h5 hp-font-weight-500 hp-text-color-primary-1">
                Total
              </Col>
              <Col span={12} className="h5 hp-text-right hp-p1-body hp-font-weight-500 hp-text-color-primary-1">
                ${totalPrice + summaryOtherPrice.delivery + summaryOtherPrice.tax + summaryOtherPrice.insurance}
              </Col>
            </Row>
          </Col>
