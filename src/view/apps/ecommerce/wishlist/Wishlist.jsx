...
export default function Wishlist() {
  ...
  return (
    <Row gutter={[32, 32]} className="hp-ecommerce-app hp-mb-32">
      <Col span={24}>
        <Row gutter={[32, 32]}>
          <BreadCrumbs breadCrumbParent="Applications" breadCrumbParent2="E-Commerce" breadCrumbActive="Wishlist" />
        </Row>
      </Col>
      ...
      <Col span={24} className="hp-ecommerce-app-content">
        {wishlistCurrent.length !== 0 ? (
          <List
            ...
            renderItem={(value) => <WishlistProduct value={value} />}
          />
        ) : (
          <Empty
            className="hp-mt-32"
            ...
            description={<h5>Your Whishlist is empty</h5>}
          >
            <Button type="primary">
