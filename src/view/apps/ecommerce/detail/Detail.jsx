        ...
        <Card className="hp-border-color-black-40">
          <Row>
            ...
            <Col lg={12} span={24} className="hp-ecommerce-app-detail-slider hp-mt-sm-24 hp-mb-md-64 hp-mb-md-32">
              {value.images ? (
                <>
                  <Slider asNavFor={nav2} infinite={false} arrows={false} ref={(slider) => (slider1 = slider)}>
                    ...
                    {value.images.map((item, index) => (
                      <div key={index} className="hp-slick-slide-item hp-mx-8 hp-d-flex-full-center">
                        <div className="hp-border-1 hp-border-color-black-40 hp-border-color-dark-80 hp-border-radius hp-d-flex-full-center">
                          <img
                            src={require(`../../../../assets/images/product/${item.img}`).default}
                            alt={item.title}
                          />
                        </div>
                      </div>
                        ...
                        {value.discount ? (
                          <>
                            ...
                            <span className="hp-d-inline-block hp-mb-6 hp-text-color-black-60 hp-text-line-through hp-p1-body hp-font-weight-500">
                              ${priceSplit1}.<sup style={{ top: -3 }}>{priceSplit2}</sup>
                            </span>
                          </>
                        ) : (
                          <span className="h2 hp-d-inline-block hp-mb-0 hp-mr-4">
                                ...
                                <div className="hp-border-radius hp-border-1 hp-border-color-black-40 hp-px-8 hp-py-12">
                                  <Row align="middle" justify="center">
                                    <Col className="hp-mr-4">
                                      <img
                                        src={require(`../../../../assets/images/product/${item.imgList}`).default}
                                        height={28}
                                        alt={item.color}
                                      />
                                    </Col>
                    ...
                    <Row gutter={[8, 8]}>
                      ...
                      <Col>
                        <Link to="/apps/ecommerce/checkout">
                          <Button block icon={<RiShoppingBagLine className="remix-icon" />} type="primary">
                            Go to Cart
                          </Button>
                        </Link>
                      </Col>
                ...
                <Col span={24}>
                  <Row gutter={[8, 8]}>
                    <Col span={24} className="hp-d-flex-center">
                      ...
                      <span className="hp-caption hp-text-color-black-80 hp-text-color-dark-30 hp-font-weight-400 hp-text-underline hp-ml-4">
                    ...
                    item.id !== value.id && (
                      <div key={index} className="hp-px-12">
                        ...
                        >
                          ...
                          <h5 className="hp-mb-0 hp-mt-24 hp-mx-12 hp-p1-body hp-font-weight-500">{item.title}</h5>
                          ...
                          <Row align="middle" justify="center">
                            ...
                            <span className="hp-d-block hp-mb-0 hp-mr-8 hp-badge-text hp-text-color-success-1">+4</span>
