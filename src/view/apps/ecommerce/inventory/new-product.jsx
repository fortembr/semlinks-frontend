    ...
    <Row gutter={[32, 32]} className="hp-ecommerce-app hp-mb-32">
      <Col span={24}>
        <Row gutter={[32, 32]} justify="space-between">
          <BreadCrumbs breadCrumbParent="Applications" breadCrumbParent2="E-Commerce" breadCrumbActive="Inventory" />
        </Row>
      </Col>
                  ...
                  <Row gutter={[24, 24]}>
                    <Col span={24}>
                      <span className="hp-d-flex hp-align-items-center hp-p1-body hp-text-color-black-100 hp-text-color-dark-0 hp-mb-8">
                        Product Title{' '}
                        <i className="ri-information-line hp-mx-4" style={{ fontSize: 16, lineHeight: 1 }} /> :
                      </span>
                    ...
                    <Col span={24}>
                      ...
                      <TextArea rows={4} placeholder="Pleaceholder Text" showCount maxLength={100} />
                    </Col>
                  </Row>
                </Card>
              </Col>
                ...
                <Card>
                  ...
                  <Row gutter={[24, 24]}>
                    <Col span={24}>
                      ...
                      <Input addonBefore="$" placeholder="Pleaceholder Text" />
                    </Col>
                  </Row>
            ...
            <div>
              <Card className="hp-mb-16">
                ...
                <div className="hp-border-radius hp-overflow-hidden hp-bg-black-10 hp-bg-dark-90 hp-mb-24 hp-text-center">
                  <img
                    src={require(`../../../../assets/images/product/action-cam-1.png`).default}
                    alt="4K Action Cam"
                  />
                </div>
              ...
              <Button type="primary" block className="hp-mt-8">
                Publish Now
              </Button>

              <span className="hp-mt-16 hp-p1-body hp-d-flex-full-center">
                <i className="ri-time-line hp-mr-8" style={{ fontSize: 18, lineHeight: 1 }} /> Last saved Dec 5, 2022 -
                23:23
              </span>
            </div>
          </Col>
