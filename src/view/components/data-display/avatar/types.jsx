      ...
      <Row>
        <Col className="hp-mb-16" lg={12} span={20}>
          ...
          <p className="hp-p1-body">
            Image, Icon and letter are supported, and the latter two kinds of avatar can have custom colors and
            background colors.
          </p>
        </Col>
        ...
        <Col span={24}>
          <Row gutter={[16, 16]} align="middle">
            ...
            <Col>
              <Avatar className="hp-text-color-danger-1 hp-bg-color-danger-4 hp-bg-color-dark-danger">D</Avatar>
            </Col>
