      ...
      <Row>
        ...
        <Col span={24}>
          <Avatar.Group>
            ...
            <Avatar className="hp-text-color-danger-1 hp-bg-color-danger-4 hp-bg-color-dark-danger">K</Avatar>
          ...
          >
            ...
            <Avatar className="hp-text-color-warning-1 hp-bg-color-warning-4 hp-bg-color-dark-warning">K</Avatar>

            <Tooltip title="Ant User" placement="top">
              <Avatar style={{ backgroundColor: '#87d068' }} icon={<User />} />
            </Tooltip>

            <Avatar style={{ backgroundColor: '#1890ff' }} icon={<RiReactjsLine />} />
          </Avatar.Group>
