    ...
    <>
      <div className="hp-mb-32">
        ...
        <p className="hp-p1-body">
          These examples for typography, including global settings, headings, body text, lists, and more. When more
      ...
      <Card className="hp-border-color-black-40 hp-overflow-hidden">
        <Row className="hp-mb-96 hp-mt-32 hp-overflow-x-auto" wrap={false}>
          <Col>
            <div className="hp-mb-24">
              <svg
                className="hp-fill-dark-0 hp-stroke-dark-80"
                width="214"
                height="214"
                viewBox="0 0 214 214"
                fill="none"
        ...
        <Row
          style={{ minHeight: 80 }}
          className="hp-py-18 hp-border-bottom-1 hp-border-top-1 hp-border-color-dark-80 hp-overflow-x-auto"
          align="middle"
          wrap={false}
        >
          <Col flex="0 0 200px">
            <p className="hp-p1-body hp-text-color-black-100 hp-text-color-dark-0 hp-font-weight-500 hp-mb-0">
              Header 1 / h1
            </p>
          </Col>
        ...
        <Row
          style={{ minHeight: 80 }}
          className="hp-py-18 hp-border-bottom-1 hp-border-color-dark-80 hp-overflow-x-auto"
          align="middle"
          wrap={false}
        >
          <Col flex="0 0 200px">
        ...
        >
          ...
          <Col flex="0 0 700px">
            <span className="hp-d-block hp-caption hp-text-color-dark-0">
              Almost before we knew it, <br /> we had left the ground.
            </span>
          </Col>
        </Row>
        ...
        >
          ...
          <Col flex="0 0 700px">
            <span className="hp-d-block hp-p1-body">
              Almost before we knew it, <br /> we had left the ground.
            </span>
          </Col>
        </Row>
        ...
        >
          ...
          <Col flex="0 0 700px">
            <span className="hp-d-block hp-p2-body">
              Almost before we knew it, <br /> we had left the ground.
            </span>
          </Col>
        </Row>
        ...
        >
          ...
          <Col flex="0 0 700px">
            <span className="hp-d-block hp-button">
              Almost before we knew it, <br /> we had left the ground.
            </span>
          </Col>
        </Row>
        ...
        >
          ...
          <Col flex="0 0 700px">
            <span className="hp-d-block hp-placeholder">
              Almost before we knew it, <br /> we had left the ground.
            </span>
          </Col>
        </Row>
        ...
        >
          ...
          <Col flex="0 0 700px">
            <span className="hp-d-block hp-input-description">
              Almost before we knew it, <br /> we had left the ground.
            </span>
          </Col>
        </Row>
        ...
        >
          ...
          <Col flex="0 0 700px">
            <span className="hp-d-block hp-input-label">
              Almost before we knew it, <br /> we had left the ground.
            </span>
          </Col>
        </Row>
        ...
        <Row style={{ minHeight: 80 }} className="hp-py-18 hp-overflow-x-auto" align="middle" wrap={false}>
          ...
          <Col flex="0 0 700px">
            <span className="hp-d-block hp-badge-text">
              Almost before we knew it, <br /> we had left the ground.
            </span>
          </Col>
        </Row>
