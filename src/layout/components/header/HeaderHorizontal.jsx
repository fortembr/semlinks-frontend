        ...
        <Col>
          ...
          <Col className="hp-mobile-sidebar-button">
            <Button
              ...
              type="text"
              onClick={showDrawer}
              icon={<RiMenuFill size={24} className="remix-icon hp-text-color-black-80" />}
            />
          </Col>
        </Col>
            ...
            <Col className="hp-mr-sm-0 hp-mr-4 hp-d-flex-center">
              {!searchHeader ? (
                <Button
                  ...
                  icon={<SearchNormal1 set="curved" className="hp-text-color-black-80 hp-text-color-dark-30" />}
                  onClick={() => searchClick()}
                />
              ) : (
                <Button
