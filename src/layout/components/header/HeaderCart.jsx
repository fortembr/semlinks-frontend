  ...
  return (
    <Col className="hp-d-flex-center hp-mr-8 hp-basket-dropdown-button">
      <Button
        ...
        icon={<ShoppingBag size="22" className="hp-text-color-black-80 hp-text-color-dark-30" />}
      />
          ...
          {cart.length !== 0 ? (
            cart.map((value, index) => (
              <div key={value.id}>
                    ...
                    <Col flex="1 0 0" className="hp-basket-dropdown-list-item-title">
                      <Row wrap={false}>
                        ...
                        <Col flex="0 0 110px" className="hp-ml-10">
                          ...
                          >
                            <h5
                              className="hp-mb-0 hp-font-weight-400 hp-p1-body hp-text-color-black-100 hp-text-color-dark-15"
                ...
                {cart.length != index + 1 && <Divider className="hp-my-4 hp-bg-color-dark-80" />}
              </div>
            ))
          ) : (
            <Empty
            ...
            <>
              <Col span={12}>
                <Link to="/apps/ecommerce/checkout" onClick={handleClick}>
                  <Button
                    block
                    type="text"
                    className="hp-bg-black-20 hp-text-color-black-100 hp-hover-text-color-primary-1 hp-hover-bg-primary-4"
                  >
                    View Cart
                  </Button>
                </Link>
              ...
              <Col span={12}>
                <Link to="/apps/ecommerce/address-information" onClick={handleClick}>
                  <Button block type="text" className="hp-text-color-black-0 hp-bg-black-100 hp-hover-bg-primary-1">
                    Checkout
                  </Button>
                </Link>
              </Col>
